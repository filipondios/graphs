...
enum code { ERR_ALLOC, ERR_REHASH, ERR_INPUT, ERR_NONE };
...
#define map_create  graph_create
#define map_destroy graph_destroy

hash_map* map_create(const size_t capacity);
